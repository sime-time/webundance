	...
	<main class="container mx-auto py-12 md:py-16">
		...
		<div class=" max-w-none">
			...
			<section class="mb-8">
				...
				<p>
					Webundance ("we", "our", or "us") respects your privacy and is committed to protecting your personal data.
			...
			<section class="mb-8">
				...
				<p>
					...
					accessed, altered, or disclosed in an unauthorized way. In addition, we limit access to your personal data to those
