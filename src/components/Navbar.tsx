    ...
    <nav class="mx-auto max-w-6xl font-medium text-white items-center flex flex-col w-full">
      <div class="py-4 px-4 md:py-6 flex flex-row flex-wrap justify-between w-full">
        ...
        <div class="flex items-center gap-4">
          <Link href="/contact" class="focus:ring-offset-3 relative hidden md:inline-flex h-fit w-fit rounded-lg border border-blue-100/20 bg-blue-200/10 px-4 py-2 text-blue-200 outline-none ring-yellow-300 transition-colors after:absolute after:inset-0 after:-z-10 after:animate-pulse after:rounded-full after:bg-yellow-100 after:bg-opacity-0 after:blur-md after:transition-all after:duration-500 hover:border-yellow-300 hover:text-yellow-300 after:hover:bg-opacity-15 focus:ring-2">Contact</Link>
